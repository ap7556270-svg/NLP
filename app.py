...
def app():
    ...
    .intro-header {
        ...
        padding: 60px 40px;
        border-radius: 25px;
        background: linear-gradient(135deg, rgba(0,255,255,0.15), rgba(0,128,255,0.1));
    ...
    .intro-header:hover {
        ...
        box-shadow: 0 12px 45px rgba(0,255,255,0.3);
    }
    ...
    .intro-header h1 {
        ...
        letter-spacing: 1px;
        text-shadow: 0px 0px 15px rgba(0,255,255,0.3);
    }
    ...
    div.stButton > button:first-child {
        ...
        box-shadow: 0px 0px 10px rgba(0, 114, 255, 0.4);
    }
    ...
    .true {background: #00e676; color: #000;}
    .false {background: #ff1744; color: #fff;}
    .mixed {background: #ffb300; color: #000;}
    .norating {background: #9e9e9e; color: #fff;}
    ...
    h2, h3, h4 {
        ...
        font-weight: 600;
        text-shadow: 0px 0px 10px rgba(0,255,255,0.15);
    }
        ...
        if not results or (len(results) == 1 and results[0]['publisher'] == "Error"):
            ...
            for r in results[:5]:  # Limit to top 5
                ...
                if "true" in rating:
                    ...
                    badge_class = "norating"

                st.sidebar.markdown(f"""
                <div class="fact-card">
                    <div><strong>Source:</strong> 📰 {r['publisher']}</div>
                    <div><strong>Verdict:</strong> <span class="badge {badge_class}">{r['rating']}</span></div>
                    <div style="margin-top:8px;"><a href="{r['url']}" class="fact-link">{r['title']}</a></div>
                </div>
                """, unsafe_allow_html=True)
