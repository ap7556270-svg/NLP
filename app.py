...
def app():
    ...
    st.markdown("""
        ...
        .intro-header {
            ...
            padding: 50px 30px;
            border-radius: 20px;
            background: linear-gradient(135deg, #1f4068 0%, #3b5998 100%);
        ...
        .intro-header h1 {
            ...
            font-weight: 800;
            margin-bottom: 10px;
            background: -webkit-linear-gradient(#f8f9fa, #50c9c3);
        ...
        <div class="intro-header">
            ...
            <h3>Where Machine Learning Meets Truth — Real-time Detection, Humor & Insights</h3>
        </div>
